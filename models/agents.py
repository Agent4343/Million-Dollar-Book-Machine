...
PUBLISHING_PACKAGE = AgentDefinition(
    ...
    outputs=["blurb", "synopsis", "metadata", "keywords", "bisac_categories", "series_hooks", "author_bio"],
...
KDP_READINESS = AgentDefinition(
    ...
    inputs=["final_chapters", "publishing_package", "user_constraints", "title", "author_name"],
...
MANUSCRIPT_FIXUP = AgentDefinition(
    ...
    outputs=["final_chapters", "fixes_applied", "fix_log"],
